...
**RClone:** This package will automatically use rclone from your system PATH if it is already installed. If rclone is not found on the PATH, it will fall back to using a bundled copy of rclone (currently version **v1.75.0**) included in the package for Linux, Windows, and macOS.
